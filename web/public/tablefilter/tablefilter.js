  ...
  return (function (o) {
        ...
        r = (function () {
          ...
          function Help(t) {
            ...
            return (
              ...
              (e.boundMouseup = null),
              (e.defaultHtml = '<div class="helpFooter"><div align="center" style="margin-top:8px;"><a href="javascript:void(0);" class="close">Close</a></div></div>'),
              ...
              },
              {
                ...
                value: function init() {
                  ...
                  if (!this.initialized) {
                    ...
                    this.instrHtml ? (this.contTgtId && i.appendChild(r), (r.innerHTML = this.instrHtml), this.contTgtId || (r.className = this.contCssClass)) : ((r.innerHTML = this.instrText), (r.className = this.contCssClass)),
    ...
    function (t, e, n) {
      ...
      var l = [
        ...
        f = ['after-filtering', 'after-populating-filter', 'after-page-change', 'after-clearing-filters', 'after-page-length-change', 'after-reset-page', 'after-reset-page-length', 'after-loading-extensions', 'after-loading-themes'],
        r = (function () {
          !(function _inherits(t, e) {
            if ('function' != typeof e && null !== e) throw new TypeError('Super expression must either be null or a function');
            (t.prototype = Object.create(e && e.prototype, { constructor: { value: t, writable: !0, configurable: !0 } })), e && _setPrototypeOf(t, e);
          ...
          (function _createClass(t, e, n) {
            ...
            },
            {
              ...
              value: function _processTerm(t, e) {
                ...
                (e = e.replace(r, '').replace(i, '').replace(s, '').replace(a, '')), (o.test(e) || u.test(e) || c.test(e) || l.test(e) || f.test(e)) && (e = Object(h.getText)(t)), '' !== e && this.highlight(t, e, this.highlightCssClass);
              },
            },
          ]),
          HighlightKeyword
    ...
    function (t, e, n) {
      ...
      t.exports = function getDateIncrementObject(t) {
        ...
        return a(t)
          ? [t, 'Milliseconds']
          : ((n = +(e = t.match(i))[1] || 1), (r = s(e[2].toLowerCase())).match(/hour|minute|second/i) ? (r += 's') : 'Year' === r ? (r = 'FullYear') : 'Week' === r ? ((r = 'Date'), (n *= 7)) : 'Day' === r && (r = 'Date'), [n, r]);
      };
    },
    function (t, e, s) {
      'use strict';
            ...
            (function _createClass(t, e, n) {
              ...
              },
              {
                ...
                value: function detectKey(t) {
                  this.enterKey &&
                    (Object(u.isKeyPressed)(t, [q.ENTER_KEY]) ? (this.filter(), Object(u.cancelEvt)(t), Object(u.stopEvt)(t)) : ((this.isUserTyping = !0), n.root.clearInterval(this.autoFilterTimer), (this.autoFilterTimer = null)));
                },
              },
              {
                key: 'onKeyUp',
                value: function onKeyUp(t) {
                  if (this.autoFilter)
                    if (((this.isUserTyping = !1), Object(u.isKeyPressed)(t, [q.ENTER_KEY, q.TAB_KEY, q.ESC_KEY, q.UP_ARROW_KEY, q.DOWN_ARROW_KEY]))) n.root.clearInterval(this.autoFilterTimer), (this.autoFilterTimer = null);
                    else {
              ...
              },
              {
                ...
                value: function getCustomOptions(t) {
                  if (!Object(K.isEmpty)(t) && this.isCustomOptions(t)) {
                    for (var e = this.customOptions, n = [], r = [], i = e.cols.indexOf(t), s = e.values[i], a = e.texts[i], o = e.sorts[i], u = 0, c = s.length; u < c; u++) r.push(s[u]), a[u] ? n.push(a[u]) : n.push(s[u]);
              ...
              },
              {
                ...
                value: function validateRow(t, e) {
                  ...
                  if (n && Object(K.isBoolean)(e)) {
                    ...
                    var r = e ? '' : q.NONE,
                      i = e ? 'true' : 'false';
                    (n.style.display = r), this.paging && n.setAttribute('validRow', i), e && (-1 === this.validRowsIndex.indexOf(t) && this.validRowsIndex.push(t), this.onRowValidated(this, t), this.emitter.emit('row-validated', this, t));
                  }
                },
              },
              {
                  ...
                  return (
                    t &&
                      ...
                      this.eachRow()(function (t) {
                        e.paging ? ('true' !== t.getAttribute('validRow') && null !== t.getAttribute('validRow')) || e.validRowsIndex.push(t.rowIndex) : e.getRowDisplay(t) !== q.NONE && e.validRowsIndex.push(t.rowIndex);
                      })),
                    this.validRowsIndex
                  );
                },
                ...
                (function buildTimeFormats() {
                  (c.parsingAliases.time = (function getTimeFormat(t) {
                    ...
                    (n = (function getTimeSeparatorSrc() {
                      ...
                      (e = c.ampmFront ? '{ampm?} {hour} (?:{minute} (?::?{second})?)?' : c.ampm.length ? '{hour}(?:' + n + '{minute?}(?:' + n + '{second?})? {ampm?}| {ampm})' : '{hour}(?:' + n + '{minute?}(?:' + n + '{second?})?)');
                    return e;
                  })()),
    ...
    function (t, e, n) {
      ...
      t.exports = function getWeekYear(t, e, n) {
        var r, i, s, a, o, u;
        return (r = c(t)), (0 !== (i = l(t)) && 11 !== i) || (n || ((s = (u = d.get(e)).getFirstDayOfWeek(e)), (a = u.getFirstDayOfWeekYear(e))), (o = f(t, !1, s, a)), 0 === i && 0 === o ? (r -= 1) : 11 === i && 1 === o && (r += 1)), r;
      };
    },
    function (t, e, n) {
      'use strict';
